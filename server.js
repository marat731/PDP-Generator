...
app.post('/api/mockups/:id/comments', (req, res) => {
    try {
        ...
        db.run(
            'INSERT INTO comments (id, mockup_id, x, y, width, height, image_index, comment, author, author_token) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
            [commentId, id, x, y, width, height, imageIndex, comment, author, authorToken]
        );
